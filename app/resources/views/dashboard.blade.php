...
<body class="bg-blue-100">
    ...
    {{-- ゴミ箱 --}}
    <a href="{{ route('pages.trashe') }}">メモ一覧ページはこちら</a>
    <form action="{{ route('pages.trashe') }}" method="POST">
        @csrf
        <button class="" type="submit">（ゴミ箱へ）</button>
    </form>
    <div class="flex h-screen">
        ...
        <div class="bg-white w-full rounded-lg my-5 mr-5 p-3 shadow-lg">
            ...
            <textarea class="w-full h-full p-3 resize-none outline-none" name="content" placeholder="Please input text content."
                form="update_form">
@isset($contents->id)
